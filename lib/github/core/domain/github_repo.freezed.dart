...
abstract class $GithubRepoCopyWith<$Res> {
  ...
  $Res call({User owner, String name, String description, int stargazerCount});
...
class _$_GithubRepo extends _GithubRepo {
  ...
  @override
  String toString() {
    return 'GithubRepo(owner: $owner, name: $name, description: $description, stargazerCount: $stargazerCount)';
  }
...
abstract class _GithubRepo extends GithubRepo {
  const factory _GithubRepo(
      ...
      required final int stargazerCount}) = _$_GithubRepo;

...
class _RepoDetailPageState extends ConsumerState<RepoDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (state.hasStarredStatusChanger) {
          ref
      ...
      child: Scaffold(
        ...
        // Body of the scaffold starts from below
        body: state.map(
          initial: (_) => Container(),
          ...
          loadSuccess: (_) {
            if (_.repoDetail.entity == null) {
              return const NoResultsDisplay(
                message:
                    'Not able to get readme for this repo\nmake sure this repo contains readme file',
              );
            } else {
              return WebView(
